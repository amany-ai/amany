...
import { ProjectPhase, TaskStatus, UserRole, Task, TeamMember } from './types';

// Fix: Added missing required properties 'email' and 'status' to each TeamMember in the collection.
