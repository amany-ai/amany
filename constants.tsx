...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    backend: 'Backend Hub',
    vault: 'Secret Vault',
    testcenter: 'QA Engine',
    integrations: 'Core Hub',
  ...
  ar: {
    ...
    chat: 'دردشة الفريق',
    srs: 'تحليل المتطلبات',
    blueprint: 'المنسق الآلي',
    tasks: 'تدفق المشروع',
    resources: 'مخطط الموارد',
    employees: 'دليل الموظفين',
    backend: 'مركز البرمجة',
    vault: 'خزنة الأسرار',
    testcenter: 'محرك الجودة',
    integrations: 'الربط المركزي',
    notifications: 'التنبيهات',
    policy: 'السياسات والعمليات',
    system_files: 'ملفات النظام',
    sovereign_os: 'نظام السيادة',
    internal_node: 'نقطة داخلية',
    command_center: 'مركز القيادة',
    cycle_progress: 'تقدم الدورة',
    ai_analysis: 'تحليل الذكاء الاصطناعي',
    risk_matrix: 'مصفوفة المخاطر',
    stack_vitality: 'حيوية النظام',
    gitlab_pulse: 'نبض جيت لاب',
    day: 'يوم',
    logout: 'تسجيل الخروج'
  }
};
